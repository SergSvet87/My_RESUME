...
function changeLangBg() {
  if (select.value === allLang[1]) {
    header.style.background = "url(../img/flag-of-ua.jpg) center / cover no-repeat"
  } else if (select.value === allLang[0]) {
    header.style.background = "url(../img/flag-of-en.jpg) no-repeat";
    header.style.backgroundSize = "100% 100%";
  } else if (select.value === allLang[2]) {
    header.style.background = "url(../img/flag-of-ru.jpg) 50% / cover no-repeat";
    header.style.backgroundSize = "100% 100%";
  }
}
